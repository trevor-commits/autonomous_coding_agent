...
4. Ran `python3 -m supervisor.closeout_evidence validate --todo todo.md --issue
   GIL-54`; output `OK`; the durable closeout package for this issue is
