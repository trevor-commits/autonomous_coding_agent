...
The user-requested round-8 review of ACA `33e9462` and global `0b180c1` completed historically and led to later repair rounds. Round 15 aligned the live test oracle with the unchanged bounded-discovery policy. PR review then found five remaining ACA containment/evidence gaps. ACA `8bef60e` denies builder access to supervisor control metadata except the exact session runtime, validates report schema and terminal coherence, prevents runtime-directory symlink escape, denies/scans nested `.autoclaw`, and fingerprints permission bits. The sixth comment concerned a generic guard-unit fixture; production still emits an empty command allowlist and the live probe proves the listed repo check is denied. Candidate record tips are ACA `59477b818cef680b13c5ecc355564b339daac922` and global `94ff9ba53312c75ccc1b9bf9001d9380139f0a00`, with global implementation `a6f6416` based on exact `origin/main@736ec0e`.

- ACA: 215 tests pass with one intentional live skip; 215/215 pass with the real Codex containment probe enabled.
...
- Candidate record-tip repetition: deterministic ACA 215 with one live skip, live-enabled ACA 215/215, strict OpenSpec 4/4, project-memory, compile/no-cache, diff/status, and the complete global verifier all pass at exact ACA `59477b818cef680b13c5ecc355564b339daac922` / global `94ff9ba53312c75ccc1b9bf9001d9380139f0a00`.
...
Provenance: executor=codex:gpt-5.5:high; audit=L4-pending; scripts=ACA-unittest,live-builder-containment,OpenSpec,project-memory,global-verify; escalations=0; routing=T3; notes=pilot retained; candidate record tips fully green; evidence-only exact repeat and review pending
