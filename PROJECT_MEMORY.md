...
- Historical round 4 was clean at ACA `9275630` and global `a2cedf6`, but later PR/release reviews correctly reopened diff, provenance, schema, concurrency, idempotency, CLI, archive, learning, budget, privacy, health-at-effect, and replaceable-input integrity defects. All accepted findings through round 8 are repaired at ACA `d6f155b` and global `5608f7f`; fresh round-9 exact-tip review remains the release gate. Evidence: `records/audits/2026-07-13-autonomous-partner-independent-review.md`.
